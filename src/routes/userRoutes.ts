...
import uploadService from "../services/multerservice";
...
userRoutes.put("/api/users/profile/:id",isLoggedIn,isUserFound,hasPermission,emailValidation,uploadService.single('image'), userService.handleUpdate)
